        ...
        static void Main()
        {
            ...
            do
            {
                ...
                if (banged)
                {
                    ...
                    Score currScore = new Score(playersName, pointsCounter);
                    if (champions.Count < 5)
                    {
                        champions.Add(currScore);
                    }
                    else
                    {
                        for (int champion = 0; champion < champions.Count; champion++)
                        {
                            if (champions[champion].Points < currScore.Points)
                            {
                                champions.Insert(champion, currScore);
